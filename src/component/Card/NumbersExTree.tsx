...
export const WeNumbersTree = () => {
  return (
    <div className='container items-center px-4 py-8 m-auto mt-5 w-4/5 '>
      <div className='flex flex-wrap pb-3 mx-4 md:mx-24 lg:mx-0'>
        <div className='w-full p-2 lg:w-1/4 md:w-1/2'>
          <div className='flex flex-col px-6 py-10 overflow-hidden bg-white hover:bg-[#960018] rounded-xl shadow-lg duration-300 hover:shadow-2xl group'>
